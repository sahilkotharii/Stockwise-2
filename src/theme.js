...
@media(max-width:768px){
  ...
  .main-wrap{margin-left:0!important;padding-bottom:76px!important}
...
@media(max-width:480px){.kgrid{grid-template-columns:1fr!important}.pgrid{grid-template-columns:1fr!important}}
`;

...
export default function Sales({ ctx }) {
  const T = useT();
  const { bills, saveBills, transactions, saveTransactions, products, vendors, channels, getStock, user, addLog, addChangeReq, invoiceSettings } = ctx;
                ...
                <tr className="trow">
                  ...
                  <td className="td">
                    <div style={{ display: "flex", gap: 3 }}>
                      ...
                      <button className="btn-ghost" onClick={() => setInvoiceBill(b)} style={{ padding: "3px 6px" }} title="View / Print Invoice"><Printer size={13} /></button>
